...
import sys
import sc2
from sc2 import run_game, maps, Race, Difficulty, portconfig
...
def main():
    ...
    enemy = Computer(Race.Random, Difficulty.CheatInsane)  # CheatInsane CheatMoney CheatVision VeryHard
    """
    ...
    if "--LadderServer" in sys.argv:
        ...
        run_game(maps.get(map_name), [bot, enemy], realtime=False, save_replay_as="Last.SC2Replay")
